  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-evenly md:h-screen py-16">
      <div className="flex justify-center flex-col items-center mb-16 md:m-0">
        <h1 className="text-5xl text-gray-800 font-bold">Cha Bear-Balete</h1>
        ...
        <Slider />
        <div className="flex pt-8 flex-col gap-4 self-start">
          <div className="flex items-center">
            <div className="text-4xl pr-4">
              <FaFacebook />
            </div>
            <h5 className="text-xl">ChaBear - Balete, Batangas</h5>
          </div>
          <div className="flex items-center">
            <div className="text-4xl pr-4">
              <FaInstagram />
            </div>
            <h5 className="text-xl">chabear.balete</h5>
          </div>
        </div>
      </div>
